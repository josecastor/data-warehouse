...
def create_redshift_cluster(config, redshift, roleArn):
    print('1.4 Create Redshit Cluster')
    from botocore.exceptions import ClientError
    try:
    ...
    print('Wait, we are checking the status of your {} redshift cluster'.format(config['DWH']['DWH_CLUSTER_IDENTIFIER']))
